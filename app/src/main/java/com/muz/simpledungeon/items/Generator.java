...
import com.muz.simpledungeon.items.food.Pasty;
import com.muz.simpledungeon.items.potions.*;
import com.muz.simpledungeon.items.rings.*;
import com.muz.simpledungeon.items.scrolls.*;
import com.muz.simpledungeon.items.wands.*;
import com.muz.simpledungeon.items.weapon.*;
import com.muz.simpledungeon.items.weapon.melee.*;
import com.muz.simpledungeon.items.weapon.missiles.*;
import com.muz.simpledungeon.plants.*;
