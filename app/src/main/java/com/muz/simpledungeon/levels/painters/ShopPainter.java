...
import com.muz.simpledungeon.actors.mobs.npcs.ImpShopkeeper;
import com.muz.simpledungeon.actors.mobs.npcs.Shopkeeper;
...
import com.muz.simpledungeon.items.Torch;
import com.muz.simpledungeon.items.Weightstone;
import com.muz.simpledungeon.items.armor.*;
import com.muz.simpledungeon.items.bags.ScrollHolder;
import com.muz.simpledungeon.items.bags.SeedPouch;
import com.muz.simpledungeon.items.bags.WandHolster;
import com.muz.simpledungeon.items.food.OverpricedRation;
import com.muz.simpledungeon.items.potions.PotionOfHealing;
import com.muz.simpledungeon.items.scrolls.ScrollOfIdentify;
import com.muz.simpledungeon.items.scrolls.ScrollOfMagicMapping;
import com.muz.simpledungeon.items.scrolls.ScrollOfRemoveCurse;
import com.muz.simpledungeon.items.weapon.melee.*;
