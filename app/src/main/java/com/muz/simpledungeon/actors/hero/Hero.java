 ...
 */
package com.muz.simpledungeon.actors.hero;
...
import com.muz.simpledungeon.Bones;
import com.muz.simpledungeon.Dungeon;
import com.muz.simpledungeon.GamesInProgress;
...
import com.muz.simpledungeon.actors.buffs.Blindness;
import com.muz.simpledungeon.actors.buffs.Buff;
import com.muz.simpledungeon.actors.buffs.Burning;
import com.muz.simpledungeon.actors.buffs.Combo;
import com.muz.simpledungeon.actors.buffs.Cripple;
import com.muz.simpledungeon.actors.buffs.Fury;
import com.muz.simpledungeon.actors.buffs.GasesImmunity;
import com.muz.simpledungeon.actors.buffs.Hunger;
import com.muz.simpledungeon.actors.buffs.Invisibility;
import com.muz.simpledungeon.actors.buffs.Light;
import com.muz.simpledungeon.actors.buffs.Ooze;
import com.muz.simpledungeon.actors.buffs.Paralysis;
import com.muz.simpledungeon.actors.buffs.Poison;
import com.muz.simpledungeon.actors.buffs.Regeneration;
import com.muz.simpledungeon.actors.buffs.Roots;
import com.muz.simpledungeon.actors.buffs.Charm;
import com.muz.simpledungeon.actors.buffs.SnipersMark;
import com.muz.simpledungeon.actors.buffs.Vertigo;
import com.muz.simpledungeon.actors.buffs.Weakness;
import com.muz.simpledungeon.actors.mobs.Mob;
import com.muz.simpledungeon.actors.mobs.npcs.NPC;
import com.muz.simpledungeon.effects.CheckedCell;
import com.muz.simpledungeon.effects.Flare;
import com.muz.simpledungeon.effects.Speck;
import com.muz.simpledungeon.items.Amulet;
import com.muz.simpledungeon.items.Ankh;
import com.muz.simpledungeon.items.DewVial;
import com.muz.simpledungeon.items.Dewdrop;
import com.muz.simpledungeon.items.Heap;
import com.muz.simpledungeon.items.Heap.Type;
import com.muz.simpledungeon.items.Item;
import com.muz.simpledungeon.items.KindOfWeapon;
import com.muz.simpledungeon.items.armor.Armor;
import com.muz.simpledungeon.items.keys.GoldenKey;
import com.muz.simpledungeon.items.keys.Key;
import com.muz.simpledungeon.items.keys.SkeletonKey;
import com.muz.simpledungeon.items.keys.IronKey;
import com.muz.simpledungeon.items.potions.Potion;
import com.muz.simpledungeon.items.potions.PotionOfMight;
import com.muz.simpledungeon.items.potions.PotionOfStrength;
import com.muz.simpledungeon.items.rings.RingOfAccuracy;
import com.muz.simpledungeon.items.rings.RingOfDetection;
import com.muz.simpledungeon.items.rings.RingOfElements;
import com.muz.simpledungeon.items.rings.RingOfEvasion;
import com.muz.simpledungeon.items.rings.RingOfHaste;
import com.muz.simpledungeon.items.rings.RingOfShadows;
import com.muz.simpledungeon.items.rings.RingOfThorns;
import com.muz.simpledungeon.items.scrolls.Scroll;
import com.muz.simpledungeon.items.scrolls.ScrollOfMagicMapping;
import com.muz.simpledungeon.items.scrolls.ScrollOfRecharging;
import com.muz.simpledungeon.items.scrolls.ScrollOfUpgrade;
import com.muz.simpledungeon.items.scrolls.ScrollOfEnchantment;
import com.muz.simpledungeon.items.wands.Wand;
import com.muz.simpledungeon.items.weapon.melee.MeleeWeapon;
import com.muz.simpledungeon.items.weapon.missiles.MissileWeapon;
import com.muz.simpledungeon.levels.Level;
import com.muz.simpledungeon.levels.Terrain;
import com.muz.simpledungeon.levels.features.AlchemyPot;
import com.muz.simpledungeon.levels.features.Chasm;
import com.muz.simpledungeon.levels.features.Sign;
import com.muz.simpledungeon.plants.Earthroot;
import com.muz.simpledungeon.scenes.GameScene;
import com.muz.simpledungeon.scenes.InterlevelScene;
import com.muz.simpledungeon.scenes.SurfaceScene;
import com.muz.simpledungeon.sprites.CharSprite;
import com.muz.simpledungeon.sprites.HeroSprite;
import com.muz.simpledungeon.ui.AttackIndicator;
import com.muz.simpledungeon.ui.BuffIndicator;
import com.muz.simpledungeon.utils.GLog;
import com.muz.simpledungeon.windows.WndMessage;
import com.muz.simpledungeon.windows.WndResurrect;
import com.muz.simpledungeon.windows.WndTradeItem;
